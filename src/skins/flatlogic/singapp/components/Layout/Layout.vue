...
import Sidebar from '@skins/flatlogic/singapp/components/Sidebar/Sidebar';
import Header from '@skins/flatlogic/singapp/components/Header/Header';
import Chat from '@skins/flatlogic/singapp/components/Chat/Chat';
import Helper from '@skins/flatlogic/singapp/components/Helper/Helper';
